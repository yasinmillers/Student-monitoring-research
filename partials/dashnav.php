<div class="col-md-3">
    <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
        <div class="panel-heading panel-collapse-trigger collapse in" data-toggle="collapse"
            data-target="#b56a566b-f812-611f-d55a-cb56db49c6f5" aria-expanded="true" style="">
            <h4 class="panel-title">My Account</h4>
        </div>

        <div id="b56a566b-f812-611f-d55a-cb56db49c6f5" class="collapse in">
            <div class="panel-body list-group">
                <ul class="list-group list-group-menu">
                    ...
                    <li class="list-group-item"><a class="link-text-color" href="/viewallpapers">All Research Papers</a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="list-group-item"><a class="link-text-color" href="/addPaper">Add Report</a></li>
                    <li class="list-group-item"><a class="link-text-color" href="/viewpapers">View Report</a></li>
                    <?php endif; ?>
