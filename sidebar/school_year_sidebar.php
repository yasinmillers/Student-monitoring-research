     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						...
						<li>
                            <a href="class.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>Group</a>
                        </li>
						<li  class="">
						...
						<li>
                            <a href="students.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Supervisor</a>
                        </li>
						<li>
                            <a href="teachers.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>Students</a>
                        </li>
							<li>
						...
						<li class="active">
                            <a href="school_year.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Reg Year</a>
                        </li>
